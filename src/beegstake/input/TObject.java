...
public class TObject extends TuioObject {
	private Shape square;

	public TObject(TuioObject tobj) {
		super(tobj);
		int size = TouchHandler.object_size;
	...
	public void paint(Graphics2D g, int width, int height) {
		...
		float scale = height/(float)TouchHandler.table_size;
	...
	public void update(TObject tobj) {
